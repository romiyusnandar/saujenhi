...
import logo from '@/assets/logo-circlee.png';
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-2xl">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Isi data dibawah ini untuk membuat akun baru.
          </p>
        </div>
        ...
        <div className="text-center">
          <Link href="/login" className="font-medium text-purple-600 hover:text-purple-500 transition duration-150 ease-in-out">
